...
# Farkli etiket tiplerinden sec
samples = [imgs[0], imgs[150], imgs[350], imgs[600]]
...
for img_path in samples:
    ...
    panels.append(cv2.resize(ov, (800, 800)))

grid = np.hstack(panels)
cv2.imwrite('check4.jpg', grid, [cv2.IMWRITE_JPEG_QUALITY, 92])
print('ok - check4.jpg')
